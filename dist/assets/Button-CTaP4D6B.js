import{r as z}from"./rolldown-runtime-Bnw7wDfq.js";import{M as q}from"./vendor-BpO4XCYx.js";import{At as H,Hn as O}from"./vendor-react-RNFk1jVI.js";var d=z(q(),1),n=O(),W=(e,i,t=!0)=>{(0,d.useEffect)(()=>{if(!e||!i||!t)return;const r=a=>{(!e.ctrl||a.metaKey||a.ctrlKey)&&(!e.alt||a.altKey)&&(!e.shift||a.shiftKey)&&a.key.toLowerCase()===e.key.toLowerCase()&&(a.preventDefault(),i(a))};return window.addEventListener("keydown",r),()=>window.removeEventListener("keydown",r)},[e,i,t])},v=({shortcut:e,variant:i="default",position:t="inline"})=>{if(!e)return null;const r=[];e.ctrl&&r.push({key:"⌘",label:"Cmd"}),e.alt&&r.push({key:"⌥",label:"Opt"}),e.shift&&r.push({key:"⇧",label:"Shift"});let a={key:e.key,label:e.key};const l={" ":{key:"␣",label:"Space"},Enter:{key:"↵",label:"Enter"},Escape:{key:"⎋",label:"Esc"},Delete:{key:"⌫",label:"Del"},Backspace:{key:"⌫",label:"Bksp"},ArrowUp:{key:"↑",label:"Up"},ArrowDown:{key:"↓",label:"Down"},ArrowLeft:{key:"←",label:"Left"},ArrowRight:{key:"→",label:"Right"},Tab:{key:"⇥",label:"Tab"},CapsLock:{key:"⇪",label:"Caps"}};return l[e.key]?a=l[e.key]:a={key:e.key.length===1?e.key.toUpperCase():e.key,label:e.key.length===1?e.key.toUpperCase():e.key},r.push(a),(0,n.jsx)("span",{className:`
      ...
      `,"aria-hidden":"true",children:t==="corner"?r.slice(0,3).map(g=>g.key).join("")+(r.length>3?"…":""):r.map(g=>g.key).join("")})},X=({children:e,content:i,position:t="top"})=>{const[r,a]=d.useState(!1),l=(0,d.useRef)(),g=()=>{l.current=setTimeout(()=>a(!0),300)},p=()=>{clearTimeout(l.current),a(!1)};return(0,n.jsxs)("div",{className:"relative inline-flex",onMouseEnter:g,onMouseLeave:p,children:[e,r&&i&&(0,n.jsxs)("div",{className:`
          ...
          `,role:"tooltip",children:[i,(0,n.jsx)("div",{className:"absolute w-2 h-2 bg-gray-900 dark:bg-black transform rotate-45 -z-10"})]})]})},Y=()=>(0,d.useCallback)(e=>{const i=e.currentTarget,t=document.createElement("span"),r=Math.max(i.clientWidth,i.clientHeight),a=r/2,l=i.getBoundingClientRect();t.style.width=t.style.height=`${r}px`,t.style.left=`${e.clientX-l.left-a}px`,t.style.top=`${e.clientY-l.top-a}px`,t.className="absolute bg-white opacity-30 rounded-full pointer-events-none animate-ripple";const g=i.querySelector(".ripple");g&&g.remove(),t.classList.add("ripple"),i.appendChild(t),setTimeout(()=>t.remove(),600)},[]),F=d.memo((0,d.forwardRef)(({children:e,variant:i="primary",size:t="md",loading:r=!1,disabled:a=!1,onClick:l,type:g="button",fullWidth:p=!1,icon:y,iconPosition:k="left",className:E="",shortcut:s,showShortcut:f=!0,shortcutPosition:c="right",shortcutVariant:m="default",tooltip:x,tooltipPosition:L="top",enableRipple:h=!0,enableShortcut:N=!0,ariaLabel:R,pressed:T,...M},_)=>{const K=(0,d.useRef)(null),S=_||K,w=Y();W(s,o=>{!a&&!r&&l&&l(o)},N&&!a&&!r);const B=(0,d.useCallback)(o=>{a||r||(h&&w(o),l?.(o))},[a,r,l,h,w]),D={primary:`
    ...
    `},A={xs:"px-2 py-1 text-xs gap-1",sm:"px-3 py-1.5 text-sm gap-1.5",md:"px-4 py-2 text-sm gap-2",lg:"px-6 py-3 text-base gap-2.5",xl:"px-8 py-4 text-lg gap-3"},u=o=>({xs:12,sm:14,md:16,lg:18,xl:20})[o]||16,U=()=>{if(x)return x;if(!s||!f)return null;const o=[];s.ctrl&&o.push("⌘"),s.alt&&o.push("⌥"),s.shift&&o.push("⇧");let b=s.key;b===" "?b="Space":b.length===1&&(b=b.toUpperCase()),o.push(b);const $=o.join(" + ");return s.description?`${s.description} (${$})`:$},j=(0,n.jsxs)("button",{ref:S,type:g,onClick:B,disabled:a||r,"aria-label":R,"aria-pressed":T,"aria-busy":r,className:`
        ${D[i]}
        ${A[t]}
        ${E}
