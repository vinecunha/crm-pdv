...
export const useSettingsMutations = (callbacks: SettingsCallbacks = {}): UseSettingsMutationsReturn => {
  ...
  const saveMutation = useMutation({
    mutationFn: (data: CompanySettings) => settingsService.saveCompanySettings(data),
