  ...
  return (
    <div className="space-y-4 max-h-[60vh] overflow-y-auto">
      ...
      {formData.discount_type === 'percent' && (
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Desconto Máximo (opcional)</label>
          <input
            type="number"
            step="0.01"
            min="0"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Valor Mínimo da Compra</label>
        <input
          type="number"
          step="0.01"
          min="0"
      ...
      {!formData.is_global && (
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Clientes Permitidos</label>
          <div className="border rounded-lg p-3">
            ...
            <div className="max-h-48 overflow-y-auto space-y-1">
              ...
              {filteredCustomers.length === 0 && (
                <p className="text-center text-gray-500 text-sm py-4">Nenhum cliente encontrado</p>
              )}
            </div>
          </div>
