            ...
            <div className="flex items-center justify-between">
              ...
              {customer ? (
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={onClearCustomer} className="text-xs text-red-500 hover:text-red-700" disabled={isMutating}>
                    Remover
                  </button>
                </div>
              ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              {coupon ? (
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={onRemoveCoupon} className="text-xs text-red-500 hover:text-red-700" disabled={isMutating}>
                    Remover
                  </button>
                </div>
              ) : (
