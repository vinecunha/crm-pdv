...
const ProductGrid = ({ 
  ...
  return (
    <>
      <div className="bg-white rounded-lg shadow-sm p-4 mb-4 dark:bg-gray-800 dark:shadow-gray-900/50">
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 dark:focus:ring-blue-400"
            />
          </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-3 max-h-[calc(100vh-250px)] overflow-y-auto">
        {products.map(product => (
          <button
            ...
            className="bg-white rounded-lg shadow-sm p-4 text-left hover:shadow-md transition-all hover:scale-105 dark:bg-gray-800 dark:hover:shadow-lg dark:hover:shadow-gray-900/50"
          >
