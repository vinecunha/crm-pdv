      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col dark:bg-gray-900">
        ...
        {isLoading ? (
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-black/50">
            ...
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-black/50">
            ...
            <div className="p-6">
              ...
              {!hasItems ? (
                <div className="text-center py-12 bg-gray-50 rounded-lg border border-gray-200 dark:bg-black/50 dark:border-gray-700">
