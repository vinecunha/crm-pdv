...
const CompanySettingsTab = ({ settings, setSettings, onSave, saving }) => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-semibold text-gray-900 mb-6 dark:text-white">Informações da Empresa</h2>
      
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2 dark:text-gray-300">Logo da Empresa</label>
          ...
          <div className="mt-4">
            <label className="block text-xs font-medium text-gray-500 mb-2 dark:text-gray-400">Ou escolha uma logo pré-definida:</label>
            <select
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Nome da Empresa *</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">CNPJ</label>
            <input
              type="text"
              value={settings.cnpj || ''}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300">Domínio</label>
            <input
              type="text"
