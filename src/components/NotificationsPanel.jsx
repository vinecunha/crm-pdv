...
import { Bell, CheckCheck, X, Info, AlertCircle, CheckCircle, AlertTriangle } from '../utils/icons'
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div
          ref={panelRef}
          className="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 overflow-hidden flex flex-col"
